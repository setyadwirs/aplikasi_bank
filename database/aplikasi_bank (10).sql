...
--
-- Host: localhost:3306
-- Generation Time: Aug 07, 2024 at 02:29 AM
...
(58, '6304503843857', '2024-08-14', '2024-08-07', 'Mau Menikah', 'SPK_KELOMPOK.pdf', 'Diajukan', ''),
(59, '6304', '2024-08-07', '2024-08-14', 'Mau Uas', 'UASPerilaku Organisasi 2024.pdf', 'Diajukan', '');
...
(3, 'Wulan Aisyah', '6354958755', 'Loktamu, 09 Juni 2020', 'Jl Banjarbaru', '08754324569', '', 'Islam', 'Perempuan', 'Bariyem', 'Admin Sales', '3.200.000', 'photo_2024-06-04_07-19-57__2_-removebg-preview (1).png', 'SPK_Kel1.pdf', '', '', ''),
...
(5, '1', 'Setya', '08634254273', 'Jl Banjarbaru', 'admin', 'admin', 'Admin', 'a.jfif');
...
INSERT INTO `tb_pinjaman` (`id_pinjaman`, `nama_nasabah`, `nik`, `email`, `tanggal_pengajuan`, `jumlah_pinjaman`, `keperluan`, `status_pengajuan`, `alasan_status`) VALUES
(2, 'Adam', '2434233444', 'fauzipurwanto7787@gmail.com', '2024-07-21', '3.2', 'sd', 'Disetujui', 'GAS COK');
...
--
ALTER TABLE `tb_absensipulang`
  MODIFY `id_absensipulang` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT for table `tb_cuti`
--
ALTER TABLE `tb_cuti`
  MODIFY `id_cuti` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `tb_konsumsi`
  MODIFY `id_konsumsi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tb_nasabah`
--
ALTER TABLE `tb_nasabah`
  MODIFY `id_nasabah` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
