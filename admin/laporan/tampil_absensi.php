<div class="card">
	<div class="card-header">
		<h3 class="card-title">
			<i class=""></i> Laporan Absensi Datang
		</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
				...
				<div class="tab-content px-1 pt-1">
					<div class="tab-pane active" id="tab11" role="tabpanel" aria-labelledby="base-tab11"><br>
						...
						<div class="row">
							<div class="col-md-3 text-right">
								<form method="GET"  action="admin/absensi/cetak_filter.php">
					...
					<div class="tab-pane" id="tab12" role="tabpanel" aria-labelledby="base-tab12"><br>
						<div class="row">
							...
							<a href="admin/absensi/cetak_absensi.php" target="_blank" class="btn btn-info">
		...
		<h3 class="card-title">
			...
			<div class="card-body">
				<div class="table-responsive">
					<div>
						<!-- <a href="admin/absensi/cetak_absensi.php" target="_blank" class="btn btn-info">
					<i class="fa fa-print"></i> Cetak Data Absensi</a> -->
					</div>
					<br>
