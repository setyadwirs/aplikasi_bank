...
$print = isset($_GET['pencarian']) ? $_GET['pencarian'] : "semua";
$select_sql = "";

if ($print == "semua") {
    $select_sql = "SELECT * FROM tb_karyawan";
} else {
    $select_sql = "SELECT * FROM tb_karyawan WHERE id_karyawan = '$print'";
}

$query = mysqli_query($koneksi, $select_sql);
?>
