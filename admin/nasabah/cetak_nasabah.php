                ...
                <table border="1" cellspacing="0" width="100%">
                    <thead>
                        <tr style="background-color: darkgrey" height="30px">
                            ...
                            <th style="text-align: center; font-size: 18px;">Tempat, Tanggal Lahir</th>
                            ...
                            <th style="text-align: center; font-size: 18px;">Agama</th>
                            <th style="text-align: center; font-size: 18px;">Nama Ibu</th>
                            <th style="text-align: center; font-size: 18px;">Pekerjaan</th>
                            <th style="text-align: center; font-size: 18px;">Pendapatan</th>
                            <th style="text-align: center; font-size: 18px;">Email</th>
                            <th style="text-align: center; font-size: 18px;">Foto</th>
                            <th style="text-align: center; font-size: 18px;">File KTP</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center"><?php echo $data['pendapatan']; ?></td>
