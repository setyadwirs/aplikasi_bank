...
$sql = "SELECT * FROM tb_cuti JOIN tb_karyawan ON tb_cuti.id_karyawan = tb_karyawan.id_karyawan";
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center"><?php echo $data['tanggal_sampai']; ?></td>
                                <td align="center"><?php echo $data['alasan_cuti']; ?></td>
