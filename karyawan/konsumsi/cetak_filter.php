...
if (isset($_GET['start_date']) && isset($_GET['end_date'])) {
    ...
    $select_sql = mysqli_query($koneksi, "SELECT * FROM tb_konsumsi JOIN tb_karyawan ON tb_konsumsi.id_karyawan = tb_karyawan.id_karyawan
                                          WHERE tb_konsumsi.tanggal BETWEEN '$start_date' AND '$end_date'");
} else {
...
<body>
    ...
    <h3>
        <center>
            <h3 align="center" style="font-size: 16px;"><u>LAPORAN DATA KONSUMSI <br> <?php echo strtoupper(tgl_indo($start_date)); ?> SAMPAI DENGAN <?php echo strtoupper(tgl_indo($end_date)); ?></u> <br> </h3>
        </center>
    </h3>
