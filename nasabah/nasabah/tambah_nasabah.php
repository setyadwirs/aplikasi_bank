...
if (isset($_POST['Simpan'])) {
	...
	if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file_foto) && move_uploaded_file($_FILES["file_ktp"]["tmp_name"], $target_file_ktp)) {
		...
		$sql_simpan = "INSERT INTO tb_nasabah (nik, nama_nasabah, ttl, alamat, no_telepon, jenis_kelamin, agama, nama_ibu, pekerjaan, pendapatan, foto, file_ktp, username, password, level) VALUES (
            '$nik',
            '$nama_nasabah',
            '$ttl',
            '$alamat',
